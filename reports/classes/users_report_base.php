...
/**
 * Table class for users report
 */
class users_report_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'users_report_base';
		$this->TableName = 'users report';
		$this->TableType = 'VIEW';
		...
		// user_Id
		$this->user_Id = new ReportField('users_report_base', 'users report', 'x_user_Id', 'user_Id', '`user_Id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// User_Type
		$this->User_Type = new ReportField('users_report_base', 'users report', 'x_User_Type', 'User_Type', '`User_Type`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->User_Type->Lookup = new ReportLookup('User_Type', 'users_report_base', TRUE, 'User_Type', ["User_Type","","",""], [], [], [], [], [], [], '`User_Type` ASC', '');
		$this->User_Type->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['User_Type'] = &$this->User_Type;

		// first_name
		$this->first_name = new ReportField('users_report_base', 'users report', 'x_first_name', 'first_name', '`first_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->first_name->DateFilter = "";
		$this->fields['first_name'] = &$this->first_name;

		// last_name
		$this->last_name = new ReportField('users_report_base', 'users report', 'x_last_name', 'last_name', '`last_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->last_name->Sortable = TRUE; // Allow sort
		$this->last_name->DateFilter = "";
		$this->fields['last_name'] = &$this->last_name;

		// email_Id
		$this->email_Id = new ReportField('users_report_base', 'users report', 'x_email_Id', 'email_Id', '`email_Id`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`users report`";
	}
