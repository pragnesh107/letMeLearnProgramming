...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'I9UzFhy5APrt8LEM'); // Random key for encryption
...
$PROJECT_ID = "{3795794f-7dbe-4e1a-9957-b11d2efa9b74}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$NAVBAR_CLASS = "main-header navbar navbar-expand navbar-light bg-warning";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "programming_blog", "qs" => "`", "qe" => "`");
